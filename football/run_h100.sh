...
do
    ...
    echo "===================================="
    # 1) Treino
    /home/user_guilhermefer/python39/bin/python3 train_ppo.py --stage $STAGE
    ...
    /home/user_guilhermefer/python39/bin/python3 watch_agent.py --model_name $MODEL_PATH --scenario $SCENARIO
